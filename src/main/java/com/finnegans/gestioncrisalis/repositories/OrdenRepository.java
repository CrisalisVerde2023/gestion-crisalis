...
public interface OrdenRepository extends JpaRepository<Orden,Long>{
    ...
    @Query("SELECT od.productoServicio.id FROM OrdenDetalle od WHERE od.orden.id = :orderId AND od.tipo IN ('PRODUCTO', 'SERVICIO')")
    List<Integer> findProdsServsIdsByOrderId(@Param("orderId") Long orderId);
