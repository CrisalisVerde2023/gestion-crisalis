...
const HOST_API_PEDIDOS_DESCUENTOS = "http://localhost:8080/api/reportes/mayorDescuento";

export const TablePedidoMayorDescuento = () => {
                            ...
                            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                    <tr>
                                        ...
                                        <th scope="col" className="px-4 py-3 text-center">ID Orden</th>
                                            ...
                                            return (
                                                <React.Fragment key={idx}>
                                                    ...
                                                    <tr className="border-b dark:border-gray-700">
                                                        ...
                                                        <td className="p-4 font-semibold text-center">{el.idOrden}</td>
                                                        <td className="p-4 font-semibold text-right">$ {(el.descuento || 0).toFixed(2)}</td>
                                                    </tr>
